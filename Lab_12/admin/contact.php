...
// import klas PHPMailera - Exception, PHPMailer

use PHPMailer\PHPMailer\PHPMailer;
use PHPMailer\PHPMailer\Exception;

// wymaganie plików zawierających definicje klas

require '../PHPMailer/src/PHPMailer.php';
require '../PHPMailer/src/SMTP.php';
require '../PHPMailer/src/Exception.php';

// funkcja PokazKontakt() wyświetla formularz wykorzystywany do wysłania maila
...
// funkcja WyslijMailKontakt() wysyła mail'a na podstawie danych wpisanych do formularza
...
WyslijMailKontakt(); // wywołanie funkcji WyslijMailKontakt()

...
// plik index.php słążacy do dynamicznego generowania stron
...
<body>
    <div id="container">
        ...
        <div id="menu">
            ...
            <div class="option"><a href="./admin/sklep.php"><b>Sklep</b></a></div>
            <div style="clear:both;"></div>
        </div>
        ...
        include('showpage.php'); // załączenie pliku showpage.php

        // Wyświetlanie stron internetowych na podstawie ich ID z bazy danych
